      ...
      function getCoffee(coffeeName, cost){
        if(money.value >= cost){
          ...
          info.innerText = "Идет приготовление напитка, ожидайте...";
          ...
          let timerId = setInterval(()=>{
            ...
            if(progressCount < 30){
              info.innerHTML = `Идет приготовление напитка,<br> <i class="fas fa-hourglass-start"></i> ожидайте...`
            }else if(progressCount<60){
              info.innerHTML = `Идет приготовление напитка,<br> <i class="fas fa-hourglass-half"></i> ожидайте...`
            }else if(progressCount>60){
              info.innerHTML = `Идет приготовление напитка,<br> <i class="fas fa-hourglass-end"></i> ожидайте...`;
            }
              
            if (progressCount == 100){
              info.innerHTML = "<i class='fas fa-mug-hot'></i> Напиток "+coffeeName+" готов"; 
